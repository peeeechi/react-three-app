...
{
    public class MinebeaForceSensorEthernetClient: IDisposable
    {
        ...
        public MinebeaForceSensorEthernetClient()
        {
        ...
        public MinebeaForceSensorEthernetClient(string sensorIP, int sensorPort, int localPort)
        {
        ...
        ~MinebeaForceSensorEthernetClient()
        {
